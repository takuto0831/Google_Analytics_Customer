...
- country: 首都をtzとする
    - 
- city: 大きな国(ロシア, 中国, アメリカ等)について個別に選択する
...
tmp <- 
  ...
  mutate(DateTimeLocal = # country
           case_when(
             ...
             country == "Russia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Spain" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Netherlands" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Italy" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Poland" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Indonesia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Philippines" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Singapore" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Ireland" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Malaysia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Romania" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Ukraine" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Israel" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Peru" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Sweden" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "South Korea" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Argentina" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Colombia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
             country == "Hong Kong" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ),
