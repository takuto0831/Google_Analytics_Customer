...
train_flat <- 
  ...
  mutate(DateTimeLocal = # country
           case_when(
             ...
             country == "Sri Lanka" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Nigeria" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Croatia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Ecuador" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Tunisia" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Belarus" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Kazakhstan" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Finland" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Dominican Republic" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
             country == "Bosnia & Herzegovina" ~ as.POSIXct(visitStartTime, origin='1970-01-01', tz = ""),
